...
public partial class DrivingLicenseContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5860499A2FF");
        ...
        {
            entity.HasKey(e => e.AnswerId).HasName("PK__Answer__D4825024644CCF24");
        ...
        {
            entity.HasKey(e => e.AttemptId).HasName("PK__Attempt__891A6886EFAC5CD1");
        ...
        {
            entity.HasKey(e => e.AttemptDetailId).HasName("PK__AttemptD__D271E13024A76575");
        ...
        {
            entity.HasKey(e => e.LicenseId).HasName("PK__License__72D600A2E6F8E065");
        ...
        {
            entity.HasKey(e => e.QuestionId).HasName("PK__Question__0DC06F8C0B7DC5B6");
        ...
        {
            entity.HasKey(e => e.QuizId).HasName("PK__Quiz__8B42AE6E04D554BE");
            ...
            entity.HasMany(d => d.Questions).WithMany(p => p.Quizzes)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("QuizId", "QuestionId").HasName("PK__Have__5B9EA896ED2E9753");
                        j.ToTable("Have");
        ...
        {
            entity.HasKey(e => e.RentId).HasName("PK__Rent__783D4015BE831DD1");
        ...
        {
            entity.HasKey(e => e.ScheduleId).HasName("PK__Schedule__9C8A5B69307DE068");
        ...
        {
            entity.HasKey(e => e.TeacherId).HasName("PK__Teacher__EDF25944C22993C9");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCAC427FCFEA");
        ...
        {
            entity.HasKey(e => e.VehicleId).HasName("PK__Vehicle__476B54B216BB0DD6");
